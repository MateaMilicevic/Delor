...
<body>
		<nav id="myNavbar" class="navbar navbar-toggleable-md navbar-light bg-faded">
		  ...
		  <div class="collapse navbar-collapse" id="navbarResponsive">
		    <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item option"><a class="nav-link" href="">Narudžbe &amp; Dostava</a></li>
	...
	<div class="container-fluid">
		...
		<div id="glavni" class="row">
			...
			<div id="reklame1" class="col-12 col-md-4 d-flex flex-column justify-content-center align-items-center">
			  	<div>
